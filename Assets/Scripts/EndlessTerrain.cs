    ...
    public class TerrainChunk
    {
        ...
        public void UpdateTerrainChunk()
        {
            if (mapDataReceived)
            {
                ...
                float viewerDstFromNearestSquare = Mathf.Sqrt(bounds.SqrDistance(viewerPosition));
                bool visible = viewerDstFromNearestSquare <= maxViewDst;
                ...
                if (visible)
                {
                    ...
                    {
                        if (viewerDstFromNearestSquare > detailLevels[i].visibleDstThreshold)
                        {
                            lodIndex = i + 1;
                        }
                        else
